...
phd = open("Data\\raw_sequence_files\\cleaned_" + sample +
...
# Read ab1 file
abif = SeqIO.read("Data\\raw_sequence_files\\cleaned_" + sample +
                  "-ITS1F.ab1", "abi")
...
# Create moving sum of max signal values to find where quality deteriorates
window = 5
...
test_seq = SeqRecord(Seq(new_seq), id="SampleID" + "1",
                     description="No description")
SeqIO.write(test_seq, "Data\\cleaned_sequences\\cleaned" + sample +
            ".faa", "fasta")
